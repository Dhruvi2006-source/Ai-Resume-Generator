...
const Features = () => {
  ...
  return (
    <div className="flex flex-col items-center scroll-mt-12 bg-violet-50">
      <div className="flex items-center divide-x divide-gray-300 py-1 text-sm border border-gray-300 rounded-full">
        <span className="pr-1 pl-3 text-2xl">🔥</span>
        <span className="pl-2 pr-5 text-2xl bg-linear-to-r from-rose-500 to-indigo-500 font-medium bg-clip-text text-transparent">
          Easy to Use
        </span>
      </div>
...
' />
      ...
      <div className=" h-fit flex flex-col md:flex-row items-center justify-center">
        <img
        ...
        >
          <div
            className={
              "flex items-center justify-center gap-0 max-w-md group cursor-pointer"
            }
          >
            <div
